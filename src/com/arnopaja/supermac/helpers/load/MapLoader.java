...
public class MapLoader {
    ...
    public static void initTileMap() {
        ...
        Tile.TILE_MAP.put("wh",   AssetLoader.wh);
        Tile.TILE_MAP.put("wv",   AssetLoader.wv);
        Tile.TILE_MAP.put("wne",  AssetLoader.wne);
        Tile.TILE_MAP.put("wse",  AssetLoader.wse);
        Tile.TILE_MAP.put("wsw",  AssetLoader.wsw);
        Tile.TILE_MAP.put("wnw",  AssetLoader.wnw);
        Tile.TILE_MAP.put("wtn",  AssetLoader.wtn);
        Tile.TILE_MAP.put("wte",  AssetLoader.wte);
        Tile.TILE_MAP.put("wts",  AssetLoader.wts);
        Tile.TILE_MAP.put("wtw",  AssetLoader.wtw);
        Tile.TILE_MAP.put("wp",   AssetLoader.wp);
        Tile.TILE_MAP.put("wen",  AssetLoader.wen);
        Tile.TILE_MAP.put("wee" , AssetLoader.wee);
        Tile.TILE_MAP.put("wes",  AssetLoader.wes);
        Tile.TILE_MAP.put("wew",  AssetLoader.wew);
        Tile.TILE_MAP.put("wene", AssetLoader.wene);
        Tile.TILE_MAP.put("wese", AssetLoader.wese);
        Tile.TILE_MAP.put("wesw", AssetLoader.wesw);
        Tile.TILE_MAP.put("wenw", AssetLoader.wenw);
        Tile.TILE_MAP.put("wetn", AssetLoader.wetn);
        Tile.TILE_MAP.put("wets", AssetLoader.wets);
        Tile.TILE_MAP.put("wetw", AssetLoader.wetw);
        Tile.TILE_MAP.put("wete", AssetLoader.wete);
